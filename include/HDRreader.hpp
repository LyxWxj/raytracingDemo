...
#ifndef __HDR_READER__
#define __HDR_READER__
#include "hdrloader.h"
#include <glad/glad.h>
#include <string>
...
namespace rt {
	...
	GLuint loadHDR(string const& hdrpath, HDRLoaderResult& hdrRes) {
		bool r = HDRLoader::load(hdrpath.c_str(), hdrRes);
		GLuint hdrMap = getTextureRGB32F(hdrRes.width, hdrRes.height);
